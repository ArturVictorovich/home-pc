...
var myCar = function () {
    var _classDecorators = [changeAmountOfFuel(15), chengeDoorStatus(false)];
    ...
    var myCar = _classThis = /** @class */ (function () {
        function myCar_1() {
            this.fuel = (__runInitializers(this, _instanceExtraInitializers), '80');
            this.open = true;
            this.freeSeats = 3;
        }
...
function checkAmountOfFuel(target, propertyKey, descriptor) {
    var oldValue = descriptor.value; //.value - старая функция
...
///Фабрика декоратров
function chengeDoorStatus(status) {
