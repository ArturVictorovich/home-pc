...
console.log(`В среднем интертсные моенты слуались каждые ${90 / gameEvents.size} раз за игру`)

for(let [min, events] of gameEvents) {
  if (min <= 45) {
    console.log(`Первая половина ${min} ${events}`)
  } else 
  console.log(`Вторая половина ${min} ${events}`)
}