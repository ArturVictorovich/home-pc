...
const [goalKeeperFrstTeam, ...fieldPlayersFirstTeam] = game.players[0];
const [goalKeeperSecTEam, ...fieldPlayersSecTeam] = game.players[1];
console.log(goalKeeperFrstTeam);
console.log(fieldPlayersFirstTeam);
console.log(goalKeeperSecTEam);
console.log(fieldPlayersSecTeam);

const allPlayers = [...pleayersTeamOne, ...pleayersTeamTwo]
console.log(allPlayers)

const newAllPlayers = [...allPlayers, "Messi", "Ronaldo", "Roonie"]

// allPlayers.push("Messi", "Ronaldo", "Roonie")
